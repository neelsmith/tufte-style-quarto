...
This is a simple book project[[Download and see documentation for Quarto](https://quarto.org/), "an open-source scientific and technical publication system." ]{.column-margin} 
 allowing you to write straighforward Markdown and achieve a layout loosely inspired by Edward Tufte and more specifically by Rachel Cockerell's book *Melting Point*. It uses Quarto to render output to both responsive HTML and PDF via Latex.
